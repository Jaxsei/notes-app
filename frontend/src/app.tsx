  ...
  return (
    <>
      <Routes>
        <Route
          path="/"
          element={!authUser ? <HomePage /> : <Navigate to="/home" />}
        />
        <Route
          path="/home"
      ...
      <Toaster
        ...
        toastOptions={{
          classNames: {
            toast:
              "rounded-xl shadow-md border border-border bg-background text-foreground",
            title: "font-semibold text-sm",
            description: "text-xs text-muted-foreground",
            actionButton:
              "bg-primary text-white hover:bg-primary/90 px-2 py-1 rounded-md",
